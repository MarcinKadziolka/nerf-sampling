...
from sphere_nerf_mod.models import SphereNeRF,MoreDirectionVectorInfo, SphereMoreViewsNeRF, SphereTwoRGB
...
class SphereBlenderTrainer(Blender.BlenderTrainer):
    ...
    def create_nerf_model(self):
        return self._create_nerf_model(model=SphereTwoRGB)
