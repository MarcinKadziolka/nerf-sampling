...
class SphereMoreViewsNeRFV4(nn.Module):
    def __init__(
        self, input_ch=3,
        ...
        #TODO add docstring
        """
        super(SphereMoreViewsNeRFV4, self).__init__()
        self.W = 256
        ...
        self.pts_linears1 = nn.ModuleList([nn.Linear(self.W + input_ch_views, self.W//2),
             nn.Linear(self.W//2, self.W)])
